...
def parse_args():
    parser = argparse.ArgumentParser(description='MMSeg test detector')
            ...
            if args.out and rank == 0:
                ...
                if cfg.dataset_type == 'VOCDataset':
                    ...
                    if eval_types:
                        ...
                        metric = dataset.evaluate(outputs, args.eval, **eval_kwargs)
                        ...
                        aggregated_results[corruption][
                            corruption_severity] = metric_dict #eval_results
                    else:
