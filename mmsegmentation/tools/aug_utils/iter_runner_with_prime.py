...
from .prime import GeneralizedPRIMEModule
from .prime import PRIMEAugModule
...
class IterBasedRunnerWithPRIME(BaseRunner):
    """Iteration-based Runner.
    This runner train models iteration by iteration.
    """
    def _init_prime_module(self):
        augmentations = []
        ...
        self.prime_module = GeneralizedPRIMEModule(
            # The mean/std values are from configs/_base_/datasets/ade20k.py
            preprocess=TransformLayer(mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375]),
            mixture_width=3,
            mixture_depth=1,
    ...
    def train(self, data_loader, **kwargs):
        ...
        tmp = self.prime_module(data_batch["img"]._data[0])
        data_batch["img"]._data[0] = tmp
        # Keys of data_batch: 'img_metas', 'img', 'gt_semantic_seg'
    ...
    def register_training_hooks(self,
        ...
        super(IterBasedRunnerWithPRIME, self).register_training_hooks(
            lr_config=lr_config,
